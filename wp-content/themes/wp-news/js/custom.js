...
jQuery(document).ready(function () {
  ...
  var mainMenuWP = jQuery('.wrapper-menu .navbar-nav>ul');
  mainMenuWP.find('li.menu-item-has-children > a').append('<i class="fas fa-angle-down"></i>');
  mainMenuWP.find(' > li').last().addClass('lastChild');
  ...
  jQuery(document).ready(function () {
    jQuery("#button-top-menu").click(function () {
      if (jQuery(".container-top-menu").hasClass("activeMenu")) {
        jQuery(".container-top-menu").removeClass("activeMenu");
        jQuery(".container-top-menu").addClass("menuInActive");
        jQuery(".container-top-menu").slideDown();
      } else {
        jQuery(".container-top-menu").removeClass("menuInActive");
        jQuery(".container-top-menu").addClass("activeMenu");
        jQuery(".container-top-menu").slideUp();
      }
    });
  });
